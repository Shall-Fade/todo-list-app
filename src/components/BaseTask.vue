<template>
  ...
  >
    <input
      ...
      type="checkbox"
      class="mr-[12px] h-[19px] w-[19px] cursor-pointer rounded-full border-[2px] border-blue bg-gray-500 ring-0 duration-150 checked:text-purple-dark hover:bg-blue-dark/20 checked:hover:bg-purple focus:ring-0 focus:ring-offset-0"
    />
    <p
    ...
    <button
      class="h-[35px] w-[35px] rounded-[4px] duration-150 hover:bg-gray-400 md:h-[30px] md:w-[30px]"
      @click="removeTask()"
    >
      <svg
        class="p-[5px] duration-150 hover:fill-danger"
        fill="#808080"
        viewBox="0 0 56 56"
